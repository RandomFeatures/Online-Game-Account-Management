...
<body>
	<div id="page">
		...
		<div id="content">
			<p id="status"></p>
			<form action="/apps/myaccount/lib/system/account_login.php" method="post" id="login">
				<fieldset>
			...
			<a href="http://[var.myserver]/apps/myaccount/?register" ><h1><p>Click here to register a New User</p></h1></a>
	</div>
